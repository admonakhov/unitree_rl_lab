...
"""
Configuration for Motion Capture (MoCap) tracking environment for Unitree 23DOF humanoid robot.
...
@configclass
class Unitree23DofMocapSceneCfg(InteractiveSceneCfg):
    """Configuration for the mocap scene with Unitree 23DOF humanoid robot."""
...
class CommandsCfg:
    ...
    motion = mdp.MotionCommandCfg(
        ...
        motion_file="/home/ant/UniTree/gym/unitree_rl_lab/g1_23dof.npz",
...
@configclass
class Unitree23DofMocapEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for Unitree 23DOF motion capture tracking environment."""

    # Scene settings
    scene: Unitree23DofMocapSceneCfg = Unitree23DofMocapSceneCfg(
        num_envs=4096,
        env_spacing=2.5
    )
...
@configclass
class Unitree23DofMocapPlayEnvCfg(Unitree23DofMocapEnvCfg):
